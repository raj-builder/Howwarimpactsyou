...
export const PRE_ESCALATION_PRICES: Record<string, WarPriceAnchors> = {
  ...
  'hormuz-2026': {
    escalationDate: '2026-02-28',
    pivotalEvent: 'US-Israeli strikes on Iran, 28 Feb 2026 — Strait of Hormuz effectively closed to commercial shipping*',
    commodities: [
      {
        id: 'brent',
        label: 'Brent Crude',
        ...
        pivotalEvent: 'Pre-escalation Brent price, 1 Feb 2026',
      },
      {
        id: 'natgas-ttf',
        label: 'Natural Gas (EU TTF)',
        ...
        postPrice: 55.7,
        anchorDate: '2026-02-01',
        pivotalEvent: 'EU TTF benchmark, Feb vs Mar 2026. Hormuz LNG disruption premium',
      },
      {
        id: 'gold',
        label: 'Gold',
        ...
        postPrice: 4434,
        anchorDate: '2026-02-01',
        pivotalEvent: 'Gold corrected from Jan highs; safe-haven rotation to USD',
      },
      {
        id: 'urea',
        label: 'Urea (Fertilizer)',
        unit: 'USD/mt',
        exchange: 'World Bank / DTN',
        prePrice: 452,
        postPrice: 674,
        anchorDate: '2026-02-01',
        pivotalEvent: 'Hormuz closure disrupted Middle East fertilizer shipments',
      },
      {
        id: 'shipping',
        label: 'Container Freight (Asia-EU)',
        unit: 'USD/TEU',
        exchange: 'SCFI',
        prePrice: 2000,
        postPrice: 5000,
        anchorDate: '2026-02-01',
        pivotalEvent: 'Spot container rates surged ~150% post-Hormuz closure',
      },
      {
        id: 'aluminium',
        label: 'Aluminium',
        ...
        postPrice: 3300,
        anchorDate: '2026-02-01',
        pivotalEvent: 'LME aluminium, Hormuz closure revised forecast above $4000/t',
      },
    ],
    consumerGoods: [
      {
        ...
        postPrice: 1199,
        anchorDate: '2026-02-01',
        pivotalEvent: 'Anticipated tariff + shipping cost pass-through to next cycle',
      },
      {
        id: 'economy-flight',
        label: 'Economy Flight (ME routes)',
        unit: 'USD',
        exchange: 'IATA / Google Flights',
        prePrice: 380,
        postPrice: 620,
        anchorDate: '2026-02-01',
        pivotalEvent: 'Rerouting around Persian Gulf airspace, fuel surcharges',
      },
      {
        id: 'electricity',
        ...
        postPrice: 148,
        anchorDate: '2026-02-01',
        pivotalEvent: 'Natural gas price pass-through to grid electricity',
      },
    ],
  },
